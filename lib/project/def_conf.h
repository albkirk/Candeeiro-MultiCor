...
#define MODELName           "MTColor"                     // Hardware model name
#define SWVer               "08.03"                       // Major.Minor Software version (use String 01.00 - 99.99 format !)
...
#define LED_ESP              2                            // 8266=2, ESP32=22, T-Call=13, TTGoTS=22, T5=19, -1 means NOT used!
#define IR_PIN               5                            // IR-LED Receiver PIN  -1 means NOT used!
...
#define PIN_RED             12                            // PWM Output PIN for RED  -1 means NOT used!
#define PIN_GREEN            4                            // PWM Output PIN for GRREN  -1 means NOT used!
#define PIN_BLUE            14                            // PWM Output PIN for BLUE  -1 means NOT used!
#define NEOPixelsPIN        19                            // GPIO pin where the NeoPixels is connected.
#define NEOPixelsNUM         8                            // Number of NeoPixels LEDs attached
